...
public class DummyDevInit extends DummyObject {
    ...
    CommandLineRunner init(MemberRepository memberRepository, TermRepository termRepository, FolderRepository folderRepository){
        return args -> {
            ...
            folderRepository.save(newFolder("새 폴더1", "새 폴더 설명1", member1));
            folderRepository.save(newFolder("새 폴더2", "새 폴더 설명2", member1));
            folderRepository.save(newFolder("새 폴더3", "새 폴더 설명3", member2));
