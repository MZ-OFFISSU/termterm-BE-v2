package site.termterm.api.global.config.redis;
...
public class RedisCacheConfig {
    ...
    @Bean
    @Primary
    public CacheManager folderIdCacheManager(RedisConnectionFactory redisConnectionFactory) {
        // Folder Id 기반 조회는 30분으로 설정
